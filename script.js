                ...
                if (userCheckData.error) {
                    ...
                    if (!welcomeMessageShown) {
                        ...
                        if (currentFetchUserLevel <= 14) {
                            welcomeMsg = `Welcome ${currentFetchUserName}, you are currently level ${currentFetchUserLevel} - Hit targets around your level.`;
                        } else {
                            welcomeMsg = `Welcome ${currentFetchUserName}, you are currently level ${currentFetchUserLevel} - Go on `;
                        }
...
async function errorLogly(name, level, error, listName) {
    const reportUrl = 'https://github.com/d4s1330rt4l1/error.php';
    const reportData = {
        name: name || 'N/A',
